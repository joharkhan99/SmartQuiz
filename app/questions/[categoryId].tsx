    ...
    <ScrollView style={{ flex: 1 }} className="w-full h-full bg-white">
      ...
      >
        ...
        <View className="flex w-full flex-row items-center gap-x-4">
          ...
          <View className="flex-1 border border-[#efefef] rounded-full p-1.5 relative">
            <View className="bg-[#efefef] w-full p-1.5 rounded-full"></View>
            <View className="bg-[#ff9b3b] w-[50%] p-1.5 rounded-full absolute left-[5.8px] top-[5.5px]"></View>
          </View>
        </View>
        ...
        <View className="flex flex-col w-full gap-3">
          ...
          >
            ...
            <Ionicons name="checkmark-circle-sharp" size={24} color="#3eb8d4" />
          </TouchableOpacity>
